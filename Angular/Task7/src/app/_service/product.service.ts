...
export class ProductService {
  private cart = new Subject<Iproduct>();
  private fav = new Subject<Iproduct>();
  ...
  // Fav
  setFavItem(item: Iproduct) {
    this.fav.next(item);
  }

  getFavItems() {
    return this.fav.asObservable();
  }
